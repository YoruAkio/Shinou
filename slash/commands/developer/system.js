...
module.exports = {
    ...
    kioRun: async (client, interaction) => {
        ...
        get({
            ...
            const serverHours = Math.floor(
                (serverSeconds % (3600 * 24)) / 3600
            );
            ...
            for (let i = 0; i < gpuControllersLength; i++) {
                ...
                gpuMain +=
                    ...
                    (gpuMainTemperatureGpu ? gpuMainTemperatureGpu : "") +
                    "```";
            }
            ...
            for (let i = 0; i < gpuDisplaysLength; i++) {
                ...
                gpuSecond +=
                    ...
                    ", " +
                    (gpuSecondMain
                        ? interaction.client.translate.commands.system.main
                        : "") +
                    "```";
            }
            ...
            const systemEmbed = new EmbedBuilder()
                .setTitle(
                    interaction.client.translate.commands.system.info_title
                )
                .setDescription(
                    interaction.client.translate.commands.system
                        .info_description
                )
                ...
                .addFields([
                    ...
                    {
                        name: interaction.client.translate.commands.system
                            .info_uptime.title,
                        value:
                            "```" +
                            interaction.client.translate.commands.system.info_uptime.info
                                .replace("%s1", serverDays)
                                .replace("%s2", serverHours) +
                            "```",
                        inline: true,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value:
                            ...
                            (batteryHasBattery
                                ? batteryIsCharging
                                    ? interaction.client.translate.commands
                                          .system.info_battery.charging +
                                          " " +
                                          batteryPercent +
                                          ", " +
                                          batteryType ||
